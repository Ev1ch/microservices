...
docker docker build -t cuisines_image services/meals/Dockerfile .
docker docker build -t cuisines_image services/ingredients/Dockerfile .
docker docker build -t cuisines_image services/client/Dockerfile .
